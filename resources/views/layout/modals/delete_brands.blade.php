<div class="modal fade" id="delete-brand-{{$brand['brand_id']}}" tabindex="-1" role="dialog" aria-labelledby="edit"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::model($brand, ['method'=>'DELETE', 'action' => ['BrandsController@destroy', $brand['brand_id']]]) !!}
            ...
            <div class="modal-body">
                <div class="alert alert-danger"><i class="fa fa-exclamation-triangle fa-lg margin-r-5"></i> Are you sure
                    you want to delete "{{$brand['brand_title']}}"?
                </div>
            </div>
