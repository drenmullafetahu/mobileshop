<div class="modal fade" id="delete-product-{{$product['product_id']}}" tabindex="-1" role="dialog" aria-labelledby="edit"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::model($brand, ['method'=>'DELETE', 'action' => ['ProductsController@destroy', $product['product_id']]]) !!}
            ...
            <div class="modal-body">
                <div class="alert alert-danger"><i class="fa fa-exclamation-triangle fa-lg margin-r-5"></i> Are you sure
                    you want to delete "{{$product['product_title']}}"?
                </div>
            </div>
